...
git config --global credential.helper /usr/local/Cellar/git/*/share/git-core/contrib/credential/netrc/git-credential-netrc.perl
keybase login
mkdir ~/.gnupg
...
password $pass
A
echo -e "5\ny\n" |  gpg --command-fd 0 --expert --edit-key "$(gpg --list-keys|sed -n '4s/^  *//p')" trust
